...
$releases = 'https://github.com/fafarunner/fafarunner/releases'

function global:au_GetLatest {
    $LatestRelease = Invoke-RestMethod -UseBasicParsing -Uri "https://api.github.com/repos/fafarunner/fafarunner/releases/latest"
